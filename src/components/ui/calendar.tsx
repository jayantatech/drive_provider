    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 rounded-[5px]"
        ),
        ...
        day_selected:
          " bg-color_main text-white hover:bg-black hover:text-white rounded-[6px]  ",
        day_today:
          "bg-accent text-accent-foreground bg-[#d3dafc] rounded-[4px]",
        day_outside:
