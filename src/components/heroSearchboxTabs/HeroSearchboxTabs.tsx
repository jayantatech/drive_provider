...
const HeroSearchboxTabs = ({ tabVehicles }: { tabVehicles: TabType[] }) => {
  ...
  return (
    <div className=" w-[320px] bg-white min-h-[48px] flex flex-row gap-2 items-center justify-center p-1 rounded-t-[6px] bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 font-bold max-md:w-[320px] ">
