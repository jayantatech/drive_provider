...
const TestimonialBox = () => {
  return (
    <div className="w-[374px] h-[250px] max-md:w-[340px] max-lg:h-[280px] max-lg:w-[230px] rounded-[6px] shadow-md border-[1px] border-black">
      ...
      <div className="w-full h-[30%] border-t shadow-md bg-[#313235] border-black p-4 max-lg:p-2 flex items-center justify-start gap-2 rounded-b-[6px]">
